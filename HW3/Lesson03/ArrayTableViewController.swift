...
class ArrayTableViewController: UITableViewController {
    ...
    */
    let animalArray = [Animal(name: "Rover"), Animal(name: "Mittens"), Animal(name: "Ein"), Animal(name: "Sadie"), Mammal(name: "Cow", color: "blue")]
    var animalObject = Animal(name: "Money")
